...
class Rook {
  ...
  async parseAllSites(sitesToParse, numTwitSites, numVxTwitSites, numPixivSites, numPhixivSites) {
    ...
    return [[await this._tweetMediaCache, await this._tweetUsernameCache, await this._tweetOriginURLCache], await this._pixivMediaCache, await this._tiktokURLCache];
  }
